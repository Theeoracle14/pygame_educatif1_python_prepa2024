...
goomba = pygame.image.load("./assets/img/perso.png").convert_alpha()
mario = pygame.image.load("./assets/img/teenage-girl.png").convert_alpha()

# importer le son
sound = pygame.mixer.Sound("./assets/audio/TOONBoing_Boing cartoon 2 (ID 2278)_LS.mp3")
...
def mario_collision (left,top):
   ...
   if (left< 50 and top<70):
      print("La fille est mort")
      mario = pygame.image.load("./assets/img/gratis-png-fantasma.png").convert_alpha()
      sound.play()
   else:
      mario = pygame.image.load("./assets/img/teenage-girl.png").convert_alpha() 
